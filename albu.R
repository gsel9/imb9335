# NOTE: In advanced PBC, one of the main concerns is a decreasing albumin level.
# REF: https://www.ncbi.nlm.nih.gov/pubmed/10514130
...
legend("topleft", c("< 3.55 albumin", ">= 3.55 albumin"), lty=1:2, lwd=2, col=c("black", "grey"))
...
# Plot survival curve.
plot(
  fit.albgrp, xlab="Years since treatment", ylab="Cumulative hazard",
  col=c("black", "grey"), lty=1:2, lwd=2, mark.time=FALSE
)
legend("bottomleft", c("< 3.55 albumin", ">= 3.55 albumin"), lty=1:2, lwd=2, 
       col=c("black", "grey"))
